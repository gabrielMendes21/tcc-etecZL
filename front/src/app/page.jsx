...
import { ChevronDown, ChevronRight, ArrowRight, Check, Clock4, Percent } from 'lucide-react'
  ...
  return (
    <main className='px-4 relative flex flex-col'>
      ...
      <div>
        ...
        <div className="dropdown flex items-end gap-2 mb-6" onClick={handleDropDown}>
        ...
        <Link href="/atividades" className='text-highlighted text-xxs underline flex items-center gap-1 mt-4'>
          Ver mais
          <ArrowRight size={12} />
        </Link>
      </div>

    ...
    <main className="px-4 space-y-10">
      ...
      <div>
        ...
        <p className="p-3 text-justify text-xs leading-relaxed">
          ...
          corporis hic sit voluptate odit consequatur, eaque eum voluptatum,
          quaerat dolorum veritatis quis exercitationem error nesciunt quibusdam
          repudiandae. Assumenda, placeat!
        </p>
      </div>
